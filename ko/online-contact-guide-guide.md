...
-	⑤ 전체 공지사항: 해당 항목을 체크할 경우 해당 조직에 연결된 **모든 서비스에** 공지사항으로 등록됩니다. 따라서 조직 내의 개별 서비스에서만 사용하는 
    ‘**전용**’ 말머리를 사용하실 수 없습니다. 
-	⑥ 상단고정
-	⑦ 제목
-	⑧ 내용
...
-	⑤ 전체 상담지식: 해당 항목을 체크할 경우 해당 조직에 연결된 **모든 서비스에** 상담지식으로 등록됩니다. 따라서 조직 내의 개별 서비스에서만 사용하는 
    ‘**전용**’ 말머리를 사용하실 수 없습니다. 
-	⑥ 상단고정
-	⑦ 제목
-	⑧ 내용
