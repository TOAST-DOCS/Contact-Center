...
이슈관리 서비스에서의 **전체 관리** 메뉴는 계약 서비스 현황, 조직관리자, 회사정보 관리, 권한 변경 로그 관리, 데이터 이관 메뉴로 구성되어 있습니다. 
...
## 회사정보 관리
![](http://static.toastoven.net/prod_contact_center/2.2.5-(6)_2_im.png)
...
## 데이터 이관
![](http://static.toastoven.net/prod_contact_center/2.1.6-(2)_im.png)
