...
|                 |type                |int     |O      |서비스 타입 (1: 상담관리, 2: 이슈관리), 기본값 = 1)|
...
|	              |language	                |String	  |O	|서비스 기본 언어 (값 : languages.code), 설정하지 않았을 경우 한국어(ko), 일본어(ja), 영어(en), 중국어(zh) 지원|
|                     |languages.code	        |String	  |X	|언어코드 (영문, 기호 '\_' 허용, 최대길이 : 6）|
|                     |languages.name	        |String	  |X	|언어명(최대길이:50)|
|                     |languages.mainFlag	|Boolean  |X	|서비스 기본언어（true, false）|
|                     |languages.orderNo	|int	  |X	|노출순서|
|                     |languages.delFlag	|Boolean  |X	|삭제 여부（true, false）|
|                     |languages.createdDt	|int	  |X     |언어 생성시간|
|                     |languages.updatedDt	|int	  |X	|언어 수정시간|
|	              |timeZone 	        |String	  |X	|타임 존（값:Asia/Seoul\|Asia/Tokyo\|...)|
...
                    "orderNo":0,
                    "delFlag":false,
                    "createdDt":1641260926284,
                    "updatedDt":1641260926284
                },
                {
                    "serviceId":"GameBaseService",
                    "code":"th",
