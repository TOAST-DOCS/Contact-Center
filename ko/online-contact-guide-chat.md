...
## 채팅 기록
![](http://static.toastoven.net/prod_contact_center/5.4-(2).png)
Online Contact에서 진행한 **채팅 상담 기록**을 확인하실 수 있습니다. 개별 채팅 기록을 클릭하면 해당 채팅 상담에 대한 구체적인 정보를 확인하실 수 있는 창이 화면 오른쪽에 표시됩니다. 
**고객정보** 및 **상담정보**를 확인 및 입력하실 수 있으며, **티켓의 생성**, **채팅 대화 내역 확인**이 가능합니다. 
채팅 상담 도중 마스킹 처리된 개인정보는 채팅 기록에서도 동일하게 마스킹되어 표시되며, 채팅 대화 내역에 대해서 **① 개인정보 마스킹** 및 **마스킹 해제**가 가능합니다. 
