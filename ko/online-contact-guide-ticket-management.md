...
티켓 클릭 시, 선택된 티켓에 대해서 **티켓정보**, **문의내역**, **이벤트** 탭을 활용하실 수 있습니다. (채팅 위젯/채팅 기록 → 티켓 만들기 기능을 통해서 생성된 티켓일 경우 **채팅 내역** 탭이 표시되어 티켓 처리 시 채팅 내역 활용 가능)

![](http://static.toastoven.net/prod_contact_center/4.1.2-(2)_1.png)

-	**① 티켓정보** : 고객 문의 관련 정보 확인 및 처리 
      - 티켓 ID : 티켓 생성 시 자동으로 생성되는 ID
      - 티켓 담당 그룹
      - 티켓 담당자
      - 티켓 상태
      - 채널 : 문의가 인입된 채널
...
- **③** 코멘트 추가: **메모**를 추가하는 것. 타 상담원에게 전달 시 활용
...
## 티켓 검색
![](http://static.toastoven.net/prod_contact_center/4.1.3-(1)_2.png)
