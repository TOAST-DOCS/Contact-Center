...
## 티켓 이관
티켓의 2차 이관이 필요할 경우, **이슈 관리** 서비스 또는 **Dooray!** 프로젝트로 티켓을 **이관**할 수 있습니다.
...
### Dooray! 이관
![](http://static.toastoven.net/prod_contact_center/4.1.4-(1).png)

이관하고자 하는 티켓에서 **① Dooray 이관** 버튼을 누르시면 Dooray! 이관 화면이 표시됩니다.
하기 정보를 입력하여 주신 후, **② 이관** 버튼을 누르시면 설정하신 프로젝트에 업무가 등록됩니다.

- 조직: 티켓을 이관할 프로젝트가 속해 있는 Dooray! 조직을 선택해주세요. [서비스 관리 → 외부채널 → Dooray!] 메뉴에 추가된 Dooray! 조직이 드롭박스 목록에 표시됩니다.
- 프로젝트: 티켓을 이관할 Dooray! 프로젝트를 선택해주세요. [서비스 관리 → 외부채널 → Dooray!] 메뉴에 추가된 Dooray! 프로젝트가 드롭박스 목록에 표시됩니다.
- 템플릿: 업무 등록 시 사용하실 템플릿을 선택해주세요. 선택된 Dooray! 프로젝트에 등록된 업무 템플릿이 드롭박스 목록에 표시됩니다.
- 태그: 업무 등록 시 사용하실 태그를 선택해주세요. 선택된 Dooray! 프로젝트에 등록된 태그가 드롭박스 목록에 표시됩니다.
- 담당자, 참조자: 업무 담당자, 참조자로 등록할 사용자를 선택해주세요. 선택된 Dooray! 조직에 멤버로 추가된 사용자가 드롭박스 목록에 표시됩니다.
- 업무 내용
...
티켓의 상태가 **Dooray 이관 완료**, **Dooray 진행 중**일 경우에는 **Dooray 코멘트** 버튼이 표시되어 등록한 업무에 댓글을 추가하실 수 있으며, 티켓의 상태가 **Dooray 답변 완료**일 경우에는 **Dooray 재이관** 버튼이 표시되어 티켓을 새로운 업무로 이관하실 수 있습니다.
