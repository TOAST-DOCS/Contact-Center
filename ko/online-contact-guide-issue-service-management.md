...
템플릿 추가 시 선택하시는 처리유형은 앞서 [서비스 관리 → 티켓 → 카테고리 관리](https://docs.toast.com/ko/Contact%20Center/ko/online-contact-guide-service-management/#_9)에서 등록해두신 처리유형입니다. 내용 본문 부분에서 마우스 우 클릭 시 링크, 이미지, 테이블을 본문 내에 삽입하실 수 있습니다.
...
-	관리자: **상담원** 권한에 **서비스 설정 메뉴 기능**이 추가된 권한 (티켓 권한 부여 가능)
-	상담원: **티켓 처리**를 위한 권한 (티켓 권한 부여 가능)
