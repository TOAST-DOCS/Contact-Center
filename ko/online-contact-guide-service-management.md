...
![](http://static.toastoven.net/prod_contact_center/2.2.3-(5)_2.png)
**시스템 필드**의 경우 항목 명, 안내 문구, 개인정보(암호화 여부), 개인정보 파기 항목의 수정이 가능하며, **필수 여부** 및 **노출 여부**의 경우 필드의 종류에 따라 수정 가능 여부가 구분됩니다.
