...
**① 상담원 필드**를 설정하려면 우측 상단 드롭박스에서 상담원 필드 항목을 선택합니다.
...
![서비스관리_필드추가](http://static.toastoven.net/prod_contact_center/OC3.0/kr/online-contact-guide-service-management_img0200.png)
...
### 템플릿 관리
티켓 템플릿은 자주 사용되는 **답변 양식을 미리 추가**하여 티켓을 신속하게 처리할 수 있는 기능입니다.

#### 템플릿 등록
![서비스관리_필드추가](http://static.toastoven.net/prod_contact_center/OC3.0/kr/online-contact-guide-service-management_img0210.png)
