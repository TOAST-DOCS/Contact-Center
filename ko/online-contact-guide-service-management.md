...
**① 트리거 추가** 버튼을 클릭하여 트리거를 생성할 수 있습니다. 상세한 설명은 트리거 추가 문단을 참고하십시오.

**②** 2개 이상의 트리거를 사용한다면 마우스로 끌어서 순서를 조정할 수 있으며, 트리거 실행 시 위에서부터 아래 순서로 실행됩니다.

**③ 비활성화** 버튼을 클릭하여 트리거를 사용 중지할 수 있습니다. 해당 트리거는 하단의 비활성화 트리거 영역으로 이동됩니다.
...
**③ 트리거 결과**는 트리거가 조건을 충족했을 때 **자동으로 실행되는 동작**을 의미합니다. **결과 추가** 버튼을 클릭하여 다양한 동작들을 구성할 수 있습니다.
  ...
  - **삭제**: 추가한 트리거 결과를 삭제합니다.
    ...
    >
    > <b>1. 할당</b>
    > ![](http://static.toastoven.net/prod_contact_center/2.2.3-(2)d_1.png)
