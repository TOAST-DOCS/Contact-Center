...
- 카테고리를 추가하려면 **카테고리 추가** 버튼을 클릭합니다.
- 추가할 카테고리의 명칭을 입력한 후 저장합니다.
- 1뎁스 카테고리를 먼저 생성한 후 2뎁스, 3뎁스 순으로 하위 카테고리를 추가할 수 있습니다.
...
> - 시스템 필드 중 제목, 이메일, 유형, 내용, 개인정보수집 필드는 시스템 상 필수입력 항목이므로 ‘아니오’ 설정이 불가합니다.
> 
> **⑤ 개인정보(암호화 여부)**
> 
