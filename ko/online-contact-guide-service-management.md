...
OPEN API에 대한 자세한 정보는 [OPEN API 가이드](https://docs.alpha-nhncloud.com/ko/Contact%20Center/ko/online-contact-api-guide-openapi-overview/)를 참고하십시오.
...
채팅 기능에 대한 자세한 사용법이 궁금하다면 [채팅 가이드](https://docs.alpha-nhncloud.com/ko/Contact%20Center/ko/online-contact-guide-chat/)를 참고하십시오.
