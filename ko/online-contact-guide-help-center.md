...
FAQ는 고객이 자주 문의하는 사항을 정리하여 헬프센터를 통해 고객에게 제공할 수 있는 기능입니다.
...
공지사항을 등록하려면 먼저 **말머리**를 등록해야 합니다.
말머리를 통해 공지사항을 분류하여 관리할 수 있습니다.

**① 말머리 등록**

- 말머리를 추가하려면 **등록** 버튼을 클릭합니다.
- **말머리 추가 대화상자**가 실행되며 **헬프센터 언어별**로 말머리 이름을 작성할 수 있습니다.
- 등록할 말머리 이름을 입력한 후 확인 버튼을 클릭합니다.
...
- 선택한 탭에 따라 배포문서 또는 초안문서 목록이 조회됩니다.
- 상태, 말머리, 제목, 태그, 등록자, 조회수, 등록시간 등의 정보를 확인할 수 있습니다.
- 상태는 진행중, 예약중, 완료로 나타나며 각 상태의 의미는 아래와 같습니다.
...
- 작성 후 **등록** 버튼 클릭 시 템플릿이 추가되어 공지사항 등록 화면에서 선택할 수 있게 됩니다.
...
- 내용을 모두 작성한 후 **초안저장** 또는 **등록** 버튼을 클릭합니다.
- **초안저장** 버튼 클릭 시 초안문서로 등록되어 헬프센터에 공개되지 않습니다.
- **등록** 버튼 클릭 시 배포문서로 등록되며 공지기간에 따라 헬프센터에 공개됩니다.
- 상담원 권한을 가진 사용자는 등록 버튼이 표시되지 않으며, 초안저장만 가능합니다.
