## Contact Center > Online Contact > サービスガイド（お問合わせ管理） > チケット管理（電話）
...
- **걸기**: 고객번호와 발신번호 ([서비스 관리 → 전화 → 발신번호 관리](https://docs.nhncloud.com/ko/Contact%20Center/ko/online-contact-guide-service-management/#_31) 메뉴에서 설정) 입력 후 전화를 발신하실 수 있습니다.
...
- **선택**: 상담원이 전화 걸기를 시도할 때, 접속 상태인 서비스에 등록되어 있는 발신번호가 드롭박스에 표시됩니다. ([서비스 관리 → 전화 → 발신번호 관리](https://docs.nhncloud.com/ko/Contact%20Center/ko/online-contact-guide-service-management/#_31) 메뉴에서 등록)
