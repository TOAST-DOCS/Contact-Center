...
#### フィールド管理 (システムフィールド)
![](http://static.toastoven.net/prod_contact_center/ja/2.2.3-(5)_1_ja.png)
...
![](http://static.toastoven.net/prod_contact_center/ja/2.2.3-(6)_1_ja.png)
...
#### テンプレート登録
![](http://static.toastoven.net/prod_contact_center/ja/2.2.3-(7)_1_ja.png)
...
テンプレート追加および修正時 **① CSS / HTML / JS スクリプト**を与えられたエディターで直接作成するか、 [サービス管理 → ヘルプセンター → ファイルアップロード管理](https://docs.toast.com/ja/Contact%20Center/ja/online-contact-guide-service-management/#_31) メニューで必要なファイル(スクリプト、フォント、イメージなど)をアップロードしてから、リソースのパスを入力することによって、ヘルプセンターの構成を変更することができます。**② 多国語コード挿入** ボタンを押すと、[サービス管理 → ヘルプセンター → 多国語コード管理] メニューで設定した言語セットリストが表示され、**選択** ボタンからテンプレート内に多言語コードを挿入できます。
