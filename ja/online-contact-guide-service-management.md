...
**①** まず [チケット → カテゴリー管理](https://docs.toast.com/ja/Contact%20Center/ja/online-contact-guide-service-management/#_9)で登録いただいた受付タイプによって、問い合わせ内容に必要なフィールドの設定可能です。에서  **受付タイプ** をクリックすると設定しておいたフィールドを閲覧でき、個人情報収集項目を除いたフィールドの順を変更できます。(個人情報収集項目の場合、常に一番下に表示されるように固定される)
...
相談トークサービスが有効化すると、既存のPlusカカとも1:1チャットは中断され、カカオトークを通じて受付された問い合わせはOnline Contactで提供するチャット機能に外部チャネル‘**카카오**’と表示され受付られます。
